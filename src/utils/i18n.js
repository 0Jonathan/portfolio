  ...
  .init({
    resources: {
      en: {
        translation: {
          // -------------------------NAVBAR--------------------------
          "job": "Professional Web Developper",
          // -------------------------ABOUT---------------------
          "mywork": "My work",
          "myproject": "Projects.",
          ...
          // ------------------------WORK-------------------------
          "overview": "Overview.",
          "overviewtext": "I'm a skilled software developer with experience in Javascript, HTML, CSS and expertise in frameworks like React, Node.js, and Three.js. I'm a quick learner and collaborate closely with clients to create efficient, scalable, and user-friendly solutions that solve real-world problems. Let's work together to bring your ideas to life!",
          // -----------------------CONTACT-------------------------
          ...
          // --------------------HERO--------------------
          "hi_i_am": "Hi, I am",
          "what_i_do": "I develop 3D visuals, user interfaces, ",
          "what_i_do_next": "application web,  site d'E-commerce ",
          // --------------------EXPERIENCE------------------
          "experience_subtext": "What I have done so far",
          "experience_headtext": "Work Experience.",
          // -------------------FEEDBACKS--------------------
      ...
      fr: {
        translation: {
          ...
          // ------------------------WORK-------------------------
          "overview": "Aperçu.",
          "overviewtext": "Je suis un développeur de logiciels qualifié avec une expérience en Javascript, HTML, CSS et une expertise dans des frameworks comme React, Node.js et Three.js. J'apprends vite et je collabore étroitement avec les clients pour créer des solutions efficaces, évolutives et conviviales qui résolvent des problèmes du monde réel. Travaillons ensemble pour donner vie à vos idées !",
          ...
          // --------------------HERO--------------------
          "hi_i_am": "Je suis",
          "what_i_do": "Je développe des visuels 3D , des interfaces utilisateurs, ",
          "what_i_do_next": "application web,  site d'E-commerce ",
          // --------------------EXPERIENCE------------------
          "experience_subtext": "Ce que j'ai fais jusqu'à présent",
          "experience_headtext": "Expérience professionnelle.",
          // -------------------FEEDBACKS--------------------
